    ...
    <div className="bg-[#0B1120]">
      <SEO 
        ...
        schema={{
          ...
          "@type": "Article",
          "headline": postWithAuthor.title,
          "description": postWithAuthor.excerpt,
          "image": postWithAuthor.featured_image ? [postWithAuthor.featured_image] : [],
          "datePublished": postWithAuthor.published_at,
          "dateModified": postWithAuthor.updated_at || postWithAuthor.published_at,
          "author": {
            "@type": "Person",
            "name": postWithAuthor.author
          },
          "publisher": {
            "@type": "Organization",
